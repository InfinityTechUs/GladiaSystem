...
INSERT INTO `db_asp`.`tbl_user` (`user_cpf`, `user_phone`, `user_name`, `user_email`, `user_password`, `user_lvl`) VALUES ('22286878711', '994635511', 'João Tancredi', 'joao@gmail.com', 'joao00', '0');
...
INSERT INTO `db_asp`.`tbl_address` (`address_cep`, `address_uf`, `address_city`, `address_district`, `address_public_place`, `fk_user_id`) VALUES ('20165844', 'RJ', 'Niterói', 'Barreto', 'Rua Guimarães Júnior 13', '2');
INSERT INTO `db_asp`.`tbl_address` (`address_cep`, `address_uf`, `address_city`, `address_district`, `address_public_place`, `address_complement`, `fk_user_id`) VALUES ('10202021', 'MA', 'Nova Iorque', 'Pastos Bons', 'Rua São João 23', 'Casa 2', '1');